                  ...
                  <ul class="slides">
                    ...
                    <?php foreach($portfolio_images as $image) { ?>
                      ...
                      <li class="text-center" data-transition="slidehorizontal" data-slotamount="default" data-masterspeed="default" data-title="<?php echo $portfolio->title; ?>">
                        ...
                        <!-- main image -->
                        <img src="<?php echo get_picture("portfolio_view", $image->img_url, "1080x426"); ?>" alt="<?php echo $portfolio->title; ?>" data-bgposition="center top"  data-bgrepeat="no-repeat" data-bgfit="cover" class="rev-slidebg">
              ...
              <div class="col-sm-4">
                <div class="image-box style-2 mb-20 bordered light-gray-bg">
                  <div class="overlay-container overlay-visible">
                    ...
                    $image = get_picture("portfolio_view", $image, "1080x426");
                    ?>
