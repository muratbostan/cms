...
class Galleries extends CI_Controller
{
      ...
      $this->form_validation->set_message(
        ...
        if($validation)
        {
          ...
          if($gallery_type != "video")
          {
            ...
            $gallery_type = ($gallery_type == "image") ? "image" :"file" ;
  ...
  public function file_upload($gallery_id, $gallery_type, $folderName){
    ...
    if($gallery_type == "image"){
      ...
      // simple Image...
      $image_252x156 = upload_picture($_FILES["file"]["tmp_name"], "uploads/$this->viewFolder/image/$folderName/",252,156, $file_name);
      $image_350x216 = upload_picture($_FILES["file"]["tmp_name"], "uploads/$this->viewFolder/image/$folderName/",350,216, $file_name);
      $image_851x606 = upload_picture($_FILES["file"]["tmp_name"], "uploads/$this->viewFolder/image/$folderName/",851,606, $file_name);
