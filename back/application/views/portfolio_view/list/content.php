<div class="row">
  <div class="col-md-12">
    <h4 class="m-b-lg">
      Portfolyo Listesi
      <a href="<?php echo base_url("portfolio/new_form"); ?>" class="btn btn-outline btn-primary btn-xs pull-right">
        ...
        <?php if(empty($items)) { ?>
          ...
          <div class="alert alert-info text-center">
            <p>Burada herhangi bir veri bulunmamaktadır. Eklemek için lütfen
              <a href="<?php echo base_url("portfolio/new_form"); ?>">tıklayınız</a></p>
            </div>
              ...
              <tbody class="sortable" data-url="<?php echo base_url("portfolio/rankSetter"); ?>">
                ...
                <?php foreach($items as $item) { ?>
                  ...
                  <tr id="ord-<?php echo $item->id; ?>">
                    ...
                    <td class="text-center"><?php echo getReadebleDate($item->finishedAt); ?></td>
