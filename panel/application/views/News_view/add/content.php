  ...
  <div class="col-md-12">
    <div class="widget">
      ...
      <div class="widget-body">
        <form action="<?php echo base_url("news/saved") ?>" method="POST" enctype="multipart/form-data">
          ...
          <?php if(isset($form_error)){ ?>
            <div class="form-group image_upload_con" style="display:<?php echo($news_type =="image") ? "block":"none"; ?>">
              <label>Görsel Seçiniz</label>
              <input type="file" name="img_url" class="form-control">
            </div>
            <div class="form-group video_url_con"style="display:<?php echo($news_type =="video") ? "block":"none"; ?>">
          ...
          <?php }else{ ?>
            ...
            <div class="form-group video_url_con">
              <label>Video URL</label>
              <input class="form-control" placeholder="Video bağlantısını buraya yapıştırınız" name="video_url">
            </div>
          <?php } ?>
